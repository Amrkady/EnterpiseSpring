...
public class NumberToArabic {
	...
	private static String arabicSuffixText = "";
	...
	private static String[] arabicOnes = new String[] { "", "æÇÍÏ", "ÇËäÇä", "ËáÇËÉ", "ÃÑÈÚÉ", "ÎãÓÉ", "ÓÊÉ", "ÓÈÚÉ",
			"ËãÇäíÉ", "ÊÓÚÉ", "ÚÔÑÉ", "ÃÍÏ ÚÔÑ", "ÇËäÇ ÚÔÑ", "ËáÇËÉ ÚÔÑ", "ÃÑÈÚÉ ÚÔÑ", "ÎãÓÉ ÚÔÑ", "ÓÊÉ ÚÔÑ",
			"ÓÈÚÉ ÚÔÑ", "ËãÇäíÉ ÚÔÑ", "ÊÓÚÉ ÚÔÑ" };
	private static String[] arabicFeminineOnes = new String[] { "", "ÅÍÏì", "ÇËäÊÇä", "ËáÇË", "ÃÑÈÚ", "ÎãÓ", "ÓÊ",
			"ÓÈÚ", "ËãÇä", "ÊÓÚ", "ÚÔÑ", "ÅÍÏì ÚÔÑÉ", "ÇËäÊÇ ÚÔÑÉ", "ËáÇË ÚÔÑÉ", "ÃÑÈÚ ÚÔÑÉ", "ÎãÓ ÚÔÑÉ", "ÓÊ ÚÔÑÉ",
			"ÓÈÚ ÚÔÑÉ", "ËãÇäí ÚÔÑÉ", "ÊÓÚ ÚÔÑÉ" };

	private static String[] arabicTens = new String[] { "ÚÔÑæä", "ËáÇËæä", "ÃÑÈÚæä", "ÎãÓæä", "ÓÊæä", "ÓÈÚæä", "ËãÇäæä",
			"ÊÓÚæä" };

	private static String[] arabicHundreds = new String[] { "", "ãÇÆÉ", "ãÆÊÇä", "ËáÇËãÇÆÉ", "ÃÑÈÚãÇÆÉ", "ÎãÓãÇÆÉ",
			"ÓÊãÇÆÉ", "ÓÈÚãÇÆÉ", "ËãÇäãÇÆÉ", "ÊÓÚãÇÆÉ" };

	private static String[] arabicAppendedTwos = new String[] { "ãÆÊÇ", "ÃáÝÇ", "ãáíæäÇ", "ãáíÇÑÇ", "ÊÑíáíæäÇ",
			"ßæÇÏÑíáíæäÇ", "ßæíäÊáíæäÇ", "ÓßÓÊíáíæäÇ" };
	private static String[] arabicTwos = new String[] { "ãÆÊÇä", "ÃáÝÇä", "ãáíæäÇä", "ãáíÇÑÇä", "ÊÑíáíæäÇä",
			"ßæÇÏÑíáíæäÇä", "ßæíäÊáíæäÇä", "ÓßÓÊíáíæäÇä" };

	private static String[] arabicGroup = new String[] { "ãÇÆÉ", "ÃáÝ", "ãáíæä", "ãáíÇÑ", "ÊÑíáíæä", "ßæÇÏÑíáíæä",
			"ßæíäÊáíæä", "ÓßÓÊíáíæä" };

	private static String[] arabicAppendedGroup = new String[] { "", "ÃáÝÇð", "ãáíæäÇð", "ãáíÇÑÇð", "ÊÑíáíæäÇð",
			"ßæÇÏÑíáíæäÇð", "ßæíäÊáíæäÇð", "ÓßÓÊíáíæäÇð" };

	private static String[] arabicPluralGroups = new String[] { "", "ÂáÇÝ", "ãáÇííä", "ãáíÇÑÇÊ", "ÊÑíáíæäÇÊ",
			"ßæÇÏÑíáíæäÇÊ", "ßæíäÊáíæäÇÊ", "ÓßÓÊíáíæäÇÊ" };
			...
			if (tens < 20) { // if we are processing under 20 numbers
				if (tens == 2 && hundreds == 0 && groupLevel > 0) { // This is special case for number 2 when it comes
					...
					if (_intergerValue == 2000 || _intergerValue == 2000000 || _intergerValue == 2000000000
						...
						retVal = String.format("%s", arabicAppendedTwos[groupLevel]); // Ýí ÍÇáÉ ÇáÇÖÇÝÉ
					} else {
						retVal = String.format("%s", arabicTwos[groupLevel]);// Ýí ÍÇáÉ ÇáÇÝÑÇÏ
					}
				} else { // General case
					if (retVal != "") {
						retVal += " æ ";
					...
					if (tens == 1 && groupLevel > 0 && hundreds == 0) {
						...
						retVal += ""; // Special case for 1 and 2 numbers like: áíÑÉ ÓæÑíÉ æ áíÑÊÇä ÓæÑíÊÇä
					} else {
	...
	public static String convertToArabic() {
		...
		while (tempNumber.compareTo(new BigDecimal(0)) > 0) {
			...
			if (groupDescription != "") { // here we add the new converted group to the previous concatenated text
				if (group > 0) {
					if (retVal != "") {
						retVal = String.format("%s %s", "æ", retVal);
					}
		...
		formattedNumber += (_decimalValue != 0) ? " æ " : "";
	...
	class CurrencyInfo {
		...
		public CurrencyInfo(Currency currency) {
			...
			case AED:
				...
				arabic1CurrencyName = "ÏÑåã ÅãÇÑÇÊí";
				arabic2CurrencyName = "ÏÑåãÇä ÅãÇÑÇÊíÇä";
				arabic310CurrencyName = "ÏÑÇåã ÅãÇÑÇÊíÉ";
				arabic1199CurrencyName = "ÏÑåãÇð ÅãÇÑÇÊíÇð";
				arabic1CurrencyPartName = "ÝáÓ";
				arabic2CurrencyPartName = "ÝáÓÇä";
				arabic310CurrencyPartName = "ÝáæÓ";
				arabic1199CurrencyPartName = "ÝáÓÇð";
				partPrecision = 2;
			...
			case JOD:
				...
				englishCurrencyPartName = "Fils";
				englishPluralCurrencyPartName = "Fils";
				arabic1CurrencyName = "ÏíäÇÑ ÃÑÏäí";
				arabic2CurrencyName = "ÏíäÇÑÇä ÃÑÏäíÇä";
				arabic310CurrencyName = "ÏäÇäíÑ ÃÑÏäíÉ";
				arabic1199CurrencyName = "ÏíäÇÑÇð ÃÑÏäíÇð";
				arabic1CurrencyPartName = "ÝáÓ";
				arabic2CurrencyPartName = "ÝáÓÇä";
				arabic310CurrencyPartName = "ÝáæÓ";
				arabic1199CurrencyPartName = "ÝáÓÇð";
			...
			case BHD:
				...
				englishCurrencyPartName = "Fils";
				englishPluralCurrencyPartName = "Fils";
				arabic1CurrencyName = "ÏíäÇÑ ÈÍÑíäí";
				arabic2CurrencyName = "ÏíäÇÑÇä ÈÍÑíäíÇä";
				arabic310CurrencyName = "ÏäÇäíÑ ÈÍÑíäíÉ";
				arabic1199CurrencyName = "ÏíäÇÑÇð ÈÍÑíäíÇð";
				arabic1CurrencyPartName = "ÝáÓ";
				arabic2CurrencyPartName = "ÝáÓÇä";
				arabic310CurrencyPartName = "ÝáæÓ";
				arabic1199CurrencyPartName = "ÝáÓÇð";
			...
			case SAR:
				...
				arabic1199CurrencyName = "ÑíÇáÇð ÓÚæÏíÇð";
				arabic1CurrencyPartName = "åááÉ";
				arabic2CurrencyPartName = "åááÊÇä";
				arabic310CurrencyPartName = "åááÇÊ";
				arabic1199CurrencyPartName = "åááÉ";
				partPrecision = 2;
			...
			case SYP:
				...
				arabic1CurrencyName = "áíÑÉ ÓæÑíÉ";
				arabic2CurrencyName = "áíÑÊÇä ÓæÑíÊÇä";
				arabic310CurrencyName = "áíÑÇÊ ÓæÑíÉ";
				arabic1199CurrencyName = "áíÑÉ ÓæÑíÉ";
				arabic1CurrencyPartName = "ÞÑÔ";
				arabic2CurrencyPartName = "ÞÑÔÇä";
				arabic310CurrencyPartName = "ÞÑæÔ";
				arabic1199CurrencyPartName = "ÞÑÔÇð";
				partPrecision = 2;
				isCurrencyPartNameFeminine = false;
				break;
			case TND:
			...
			case XAU:
				...
				arabic1CurrencyName = "ÌÑÇã";
				arabic2CurrencyName = "ÌÑÇãÇä";
				arabic310CurrencyName = "ÌÑÇãÇÊ";
				arabic1199CurrencyName = "ÌÑÇãÇð";
				arabic1CurrencyPartName = "ãáÌÑÇã";
				arabic2CurrencyPartName = "ãáÌÑÇãÇä";
				arabic310CurrencyPartName = "ãáÌÑÇãÇÊ";
				arabic1199CurrencyPartName = "ãáÌÑÇãÇð";
				partPrecision = 2;
				isCurrencyPartNameFeminine = false;
				break;
			default:
				...
				arabic2CurrencyName = "ÏíäÇÑÇä ÃÑÏäíÇä";
				arabic310CurrencyName = "ÏäÇäíÑ ÃÑÏäíÉ";
				arabic1199CurrencyName = "ÏíäÇÑÇ ÃÑÏäíÇ";
				arabic1CurrencyPartName = "ÝáÓ";
				arabic2CurrencyPartName = "ÝáÓÇä";
				arabic310CurrencyPartName = "ÝáÓ";
				arabic1199CurrencyPartName = "ÝáÓÇ";
				partPrecision = 3;
				isCurrencyPartNameFeminine = false;
			}
		}
